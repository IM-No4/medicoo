...
export default function PharmacyListScreen() {
  ...
  const sortedPharmacies = useMemo(() => {
    ...
    if (sortBy === 'rating') {
      data.sort(
        (a, b) => (b.storeRating ?? 0) - (a.storeRating ?? 0)
      );
  ...
  const renderSearch = () => (
    <View style={styles.searchSection}>
      <View style={styles.searchContainer}>
        ...
        <TouchableOpacity style={styles.scanButton} onPress={() => setIsUploadModalVisible(true)}>
            ...
            >
              <Text style={styles.filterOptionText}>
                {option === 'default' ? 'Recommended' : 
                 option === 'rating' ? 'Rating (High to Low)' : 'Distance (Nearest)'}
              </Text>
              <View style={[styles.radioButton, sortBy === option && styles.radioButtonSelected]}>
  ...
  const renderSkeleton = () => (
    <View style={styles.card}>
      ...
      <View style={styles.cardContent}>
        ...
        <View style={[styles.skeletonBox, { width: '50%', height: 14, marginBottom: 6 }]} />
    ...
    return (
      <View style={styles.endOfListContainer}>
        ...
        <Text style={styles.endOfListSubtitle}>
          {sortedPharmacies.length} {sortedPharmacies.length === 1 ? 'pharmacy' : 'pharmacies'} found in your area
        </Text>
      </View>
    );
  };
